...
PluralizationRules createEnglishPluralizationRules() {
  final result = PluralizationRules();

  _EN_irregularWordsWithMatchEnding.forEach(
  ...
  _EN_irregularWordsWithoutMatchEnding.forEach(
      (singular, plural) => result.addIrregularRule(
            singular: singular,
            plural: plural,
            matchEnding: false,
  ...
  _EN_PluralRules.forEach((pattern, replacement) => result.addPluralRule(
        pattern: RegExp(
          pattern,
          caseSensitive: false,
        ),
  ...
  _EN_singularRules.forEach((pattern, replacement) => result.addSingularRule(
        pattern: RegExp(
          pattern,
          caseSensitive: false,
        ),
  ...
  _EN_uncountables.forEach(result.addUncountable);

  return result;
}

final _EN_PluralRules = <String, String>{
...
final _EN_singularRules = <String, String>{
...
final _EN_irregularWordsWithMatchEnding = <String, String>{
  'cache': 'caches',
  'child': 'children',
...
final _EN_irregularWordsWithoutMatchEnding = <String, String>{
  'bus': 'buses',
  'ex': 'exes',
  'he': 'they',
  'herself': 'themselves',
